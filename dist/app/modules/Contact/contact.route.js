...
router.get('/', (0, auth_1.auth)(), contact_controller_1.ContactControllers.getAllContactsController);
router.get('/:id', (0, auth_1.auth)(), contact_controller_1.ContactControllers.getContactController);
router.delete('/:id', (0, auth_1.auth)(), contact_controller_1.ContactControllers.deleteContactController);
