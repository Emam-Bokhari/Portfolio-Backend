...
const getAllSkills = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (skills.length === 0) {
        throw new HttpError_1.HttpError(404, 'Skills were not found in the database');
    }
    return skills;
});
const getSkillById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!skill) {
        throw new HttpError_1.HttpError(404, 'The requested skill could not be found.');
    }
    return skill;
});
const updateSkillById = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedSkill = yield skill_model_1.Skill.findOneAndUpdate({ _id: id }, payload, {
        new: true,
        runValidators: true,
    });
    if (!updatedSkill) {
...
const deleteSkillById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const deletedSkill = yield skill_model_1.Skill.findOneAndUpdate({ _id: id, isDeleted: false }, { isDeleted: true }, { new: true });
    if (!deletedSkill) {
        throw new HttpError_1.HttpError(404, 'The requested skill could not be found.');
    }
    return deletedSkill;
